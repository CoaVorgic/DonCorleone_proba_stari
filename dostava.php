...
<form action="dostavadb.php" method="post" enctype="multipart/form-data" onSubmit="return validateForm();">
    ...
    <div style="padding-bottom: 18px;" id="data_2">Jelo<span style="color: #EE0000;"> *</span><br/>
        <input type="checkbox" name="cezar">
        <label for="hrana">Cezar salata - 450 din</label><br>
        <input type="checkbox" name="biftek">
        <label for="hrana">Biftek - 700 din</label><br>
        <input type="checkbox" name="lignje">
        <label for="hrana">Lignje na raznju - 1200 din</label><br>
        <span>Quantity<span style="color: #EE0000;"> *</span></span>
        <select id="option_1" name="opcije1" style="width : 250px;" class="form-control">
            <option>1</option>
            <option>2</option>
            <option>3</option>
            <option>4</option>
    ...
    <div style="padding-bottom: 18px;" id="data_4">Pice<span style="color: #EE0000;"> *</span><br/>
        <input type="checkbox" id="kola" name="kola">
        ...
        <input type="checkbox" id="knjaz" name="knjaz">
        <label for="pice">Knjaz Milos 1,5l - 70 din</label><br>
        <span>Quantity<span style="color: #EE0000;"> *</span></span>
        <select id="option_2" name="opcije2" style="width : 250px;" class="form-control">
            <option>1</option>
            <option>2</option>
            <option>3</option>
            <option>4</option>
    ...
    <div style="padding-bottom: 18px;">Phone<span style="color: #EE0000"> *</span><br/>
        <input type="text" id="data_6" name="phone" style="width : 250px;" class="form-control"/>
    </div>
